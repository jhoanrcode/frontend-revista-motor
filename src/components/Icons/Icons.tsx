...
export default function Icons() {
  return (
    <div className="d-flex-row">
      <Link to="mailto:joria94@hotmail.com" title="Email" className="icons">
        <span>
          <svg
      ...
      <Link
        to="https://github.com/jhoanrcode"
        title="Github"
        target="_blank"
        className="icons"
      >
      ...
      <Link
        to="https://co.linkedin.com/in/jhoanravila"
        title="Linkedin"
        target="_blank"
        className="icons"
      >
      ...
      <Link
        to="https://api.whatsapp.com/send?phone=573203645490&text=Hola%20Jhoan!"
        title="WhatsApp"
        target="_blank"
        className="icons"
      >
